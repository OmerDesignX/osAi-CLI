...
void ggml_opt_eval(ggml_opt_context_t opt_ctx, ggml_opt_result_t result) {
    ...
    const bool optimized = opt_ctx->allocated_graph == opt_ctx->gb_opt;
    const bool backward  = optimized || opt_ctx->allocated_graph == opt_ctx->gb_grad;
    opt_ctx->iter += optimized;
    if (backward) {
