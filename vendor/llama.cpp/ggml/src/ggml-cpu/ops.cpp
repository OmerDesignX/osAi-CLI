...
static void ggml_compute_forward_cross_entropy_loss_back_f32(
    ...
    for (int64_t i1 = ir0; i1 < ir1; i1++) {
        ...
        // Generalized cross entropy supports weighted or entirely masked label
        // rows. One-hot labels have sum 1 and preserve the upstream formula;
        // a zero row now produces exactly zero gradient.
        float label_sum = 0.0f;
        ggml_vec_sum_f32(nc, &label_sum, s1);
        ggml_vec_scale_f32(nc, ds0, label_sum);
