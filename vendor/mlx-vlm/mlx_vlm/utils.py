...
def load_processor(
    ...
    # PIL preprocessing avoids moving media through a second tensor runtime;
    # model forward/backward remains entirely in MLX.
...
def prepare_inputs(
    ...
    **kwargs,
    ...
    if has_videos:
        ...
        for v in videos:
            arr, s_fps = (
                load_video(str(v), fps=fps_hint, max_frames=video_max_frames or 768)
